...
national_share_df.to_csv('pushkin_national_share.csv', index=False)
print("=== National Component ===")
print(national_share_df.to_string(index=False))
print("Сохранено: pushkin_national_share.csv\n")
...
plt.tight_layout()
plt.savefig('pushkin_national_share.png', dpi=300, bbox_inches='tight')
print("Сохранено: pushkin_national_share.png\n")
...
print("\nСохранено: pushkin_tfidf_keywords.png")