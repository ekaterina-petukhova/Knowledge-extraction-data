...
print("--- Скрипт запущен: классификация Третьяковской галереи ---")

file_path = 'tretyakov_cleaned.csv'
...
df.to_csv('tretyakov_categorized.csv', index=False, encoding='utf-8-sig')
print("\nГотово! Файл 'tretyakov_categorized.csv' сохранен.")
