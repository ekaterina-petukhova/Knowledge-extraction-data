...
def remove_site_noise(text):
    """
    Удаляем типичный шум музейных сайтов:
    меню, языки, соцсети, билеты, навигацию.
    """
...
def find_foreign_collaboration(row):
    """
    Ищем foreign collaboration строго:
    в одном предложении должны быть:
    1) collaboration cue
    2) foreign country/institution signal
    3) partner не должен быть русским
    """
